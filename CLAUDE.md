...
- **Generation script:** `generate-i18n-pages.py`. Lives at `~/.openclaw/workspace/tools/pickup-sign-i18n/i18n-bundle/generate-i18n-pages.py`. It is NOT committed to this repo.
- **Translation source files:** `translations/{lang}.json`, at `~/.openclaw/workspace/tools/pickup-sign-i18n/i18n-bundle/translations/`.
...
### i18n generator
- `~/.openclaw/workspace/tools/pickup-sign-i18n/i18n-bundle/generate-i18n-pages.py`, idempotent locale page generator
- `~/.openclaw/workspace/tools/pickup-sign-i18n/i18n-bundle/translations/{lang}.json`, translation source files
